...
- [Gestion des rôles](/XetaSuite-Site/admin/roles/) - Créer et configurer les rôles
- [Gestion des permissions](/XetaSuite-Site/admin/permissions/) - Permissions granulaires
