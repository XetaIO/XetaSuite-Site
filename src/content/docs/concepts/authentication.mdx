...
- [Rôles & Permissions](/XetaSuite-Site/concepts/roles-permissions/) - Système de permissions
- [Multi-Sites](/XetaSuite-Site/concepts/multi-sites/) - Permissions par site
