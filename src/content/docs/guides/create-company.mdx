...
description: Guide pour créer et gérer les fournisseurs (Companies) dans XetaSuite.
---
...
1. **Accéder au module Fournisseurs**
   ...
   Depuis le menu latéral, cliquez sur **Fournisseurs** (disponible uniquement sur le siège).
...
3. **Remplir les informations**
   ...
   | Types | ✅ | Fournisseur pièces et/ou Maintenancier |
...
| Voir un fournisseur | `company.view` |
...
- [Mouvements de pièces](/XetaSuite-Site/guides/item-movements/) - Gérer les entrées/sorties de stock
- [Créer une maintenance](/XetaSuite-Site/guides/create-maintenance/) - Planifier une maintenance
