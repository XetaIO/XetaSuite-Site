...
- [Gérer les incidents](/XetaSuite-Site/guides/manage-incidents/) - Signaler et suivre les incidents
- [Mouvements de pièces](/XetaSuite-Site/guides/item-movements/) - Gérer le stock
